...
const PromoCard = () => {
  return (
    <div className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6 m-6 md:w-full lg:w-[60%]  justify-center mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-[#eef5ff] rounded-lg w-full">
        <div className="flex flex-col items-start p-4 w-[40%]">
